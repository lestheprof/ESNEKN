...
data=load('/dataset/SAD_data_tr.mat');
training_Data=data.SAD_data_tr(:  ,1);
training_label=data.SAD_data_tr(: ,2);
...
testing_Data=data.SAD_data_ts(: ,1);
testing_label=data.SAD_data_ts(:,2);
