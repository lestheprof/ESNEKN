function [TrainingAccuracy, TestingAccuracy, TY, conf_matrix] = elm_kernel_1(TrainingData_File, TestingData_File, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)

% Usage: elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
% OR:    [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
%
% elm_kernel_1 is experimetal version, aimed at returning test result data
% to allow segment-based classificarion. LSS 29 10 2018.
% Changes
%   returns TY, 2 D array of retuts from testing, no of classes by number of test data elements,
%   1st dimension is the output value for each class, 2nd dimension is number of test data elements    
%
% Input:
