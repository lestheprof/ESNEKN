function [TrainingAccuracy, TestingAccuracy, conf_matrix] = elm_kernel(TrainingData_File, TestingData_File, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
